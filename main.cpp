...
//            long long off = getOffsetByID(doctorPrimary, id);
//            if(off==-1){ cout << "ID not found\n"; }
//            else{
//                string line = readLineAtOffset(doctorDataFile, off);
//                if(!line.empty() && line[0] != DELETE_FLAG){
//                    Doctor d = Doctor::fromLine(line); cout << d;
//                } else { cout << "Deleted or not present in file\n"; }
//            }
//        } else if(choice == "8"){
//            char id[15]; cout << "Enter Appointment ID: "; cin >> id;
//            long long off = getOffsetByID(apptPrimary, id);
//            if(off==-1){ cout << "ID not found\n"; }
//            else{
//                string line = readLineAtOffset(appointmentDataFile, off);
//                if(!line.empty() && line[0] != DELETE_FLAG){
//                    Appointment a = Appointment::fromLine(line); cout << a;
//                } else { cout << "Deleted or not present in file\n"; }
//            }
//        } else if(choice == "9"){
//            cout << "Enter query: ";
